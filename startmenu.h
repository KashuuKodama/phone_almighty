...
void StartMenu(Camera* camera){
    ...
    Texture2D* icon=open_texture("textures/profile/icon.txt");
    ...
    while (1)
    {
        ...
        */
        ...
        draw_3d_text(camera,"AIZAWA",0.01,trs(vec3(0.5,-2,9),vec3(0,0,0),vec3(0.7,0.7,1)),255);
        draw_3d_text(camera,fmod(time*4,2)<1?"Press A":"",0.1f,trs(vec3(0.5,-9,9),vec3(0,0,0),vec3(1,1,1)),255);
        draw_3d_model(camera,*circle,trs(vec3(0,2,9),vec3(-Deg2Rad*90,0,0),vec3(3,3,3)),*icon,1);
